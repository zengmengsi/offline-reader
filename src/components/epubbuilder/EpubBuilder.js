...
import Toc from './Construct/DublinCore'
import $ from 'jquery'
...
import saveAs from './FileSaver.js'
    ...
    $.extend(EpubBuilder.prototype, {
        "init" : function () {
            var _this = this;
            $.ajax({async:false, type:"get", dataType : "text" ,url:"./static/epub/mimetype", "success":function(data) {
                _this.mimetype = data;
            }});
            $.ajax({async:false, type:"get", dataType : "text" ,url:"./static/epub/META-INF/container.xml", "success":function(data) {
                _this.container = data;
            }});
            $.ajax({async:false, type:"get", dataType : "text" ,url:"./static/epub/OPS/toc.ncx", "success":function(data) {
                _this.toc = data;
            }});
            $.ajax({async:false, type:"get", dataType : "text" ,url:"./static/epub/OPS/content.opf", "success":function(data) {
                _this.contentOpt = data;
            }});
            $.ajax({async:false, type:"get", dataType : "text" ,url:"./static/epub/OPS/coverpage.html", "success":function(data) {
                _this.coverpage = data;
            }});
            $.ajax({async:false, type:"get", dataType : "text" ,url:"./static/epub/OPS/page.html", "success":function(data) {
                _this.page = data;
            }});
        },
